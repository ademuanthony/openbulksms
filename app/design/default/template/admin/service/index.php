                            ...
                            <tr>
                                ...
                                <td>
                                    <img style="margin-bottom: 10px; width: 250px" alt="No Screen shot"
                                         src="<?php echo OpenSms::getImage($service->Image) ?>" class="image img-responsive"/>
                                </td>
                                <td><?php echo $service->Name; ?></td>
                                <td><?php echo $service->Description; ?></td>
                                <td><?php echo $service->Price; ?></td>
                                <td>
                                    <a href="<?php echo OpenSms::getActionUrl('manage', 'service', 'admin', [0 => strtolower($service->Id)])?>"
